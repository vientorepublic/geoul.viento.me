				...
				<figure class="Figure"><code class="Figure__number">
					...
					<figcaption class="Figure__caption">
						<svg width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="Figure__caption__icon">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M30 1.56262L11.8628 19.6998L0 7.83705L1.26971 6.56734L11.8628 17.1604L28.7303 0.292908L30 1.56262Z" fill="#27AE60"></path>
				...
				<figure class="Figure"><code class="Figure__number">
					...
					<figcaption class="Figure__caption">
						<svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg" class="Figure__caption__icon">
							<path fill-rule="evenodd" clip-rule="evenodd" d="M13.5576 15.2929L0 1.73527L1.44238 0.292893L15 13.8505L28.5576 0.292893L30 1.73527L16.4424 15.2929L30 28.8505L28.5576 30.2929L15 16.7353L1.44238 30.2929L0 28.8505L13.5576 15.2929Z" fill="#EC5252"></path>
						</svg> <span class="Figure__caption__text"> Failed </span></figcaption>
				</figure>
			</div>
</template>
